...
#Once you have accumulated the count for each hour, print out the counts, sorted by number of times a mail has been sent maximum to minimum for a particular hour as shown below.
